...
<link rel="stylesheet" type="text/css" href="<?= base_url()?>asset/css/alert.css" />
<link type="text/css" href="<?= base_url()?>asset/css/smoothness/ui.css" rel="stylesheet" /> 
<script src="<?php echo base_url();?>asset/js/jquery-1.4.2.js" type="text/javascript"></script>
...
<!-- HIDDEN COLOR CHANGER -->      
  	...
  	<!--LOGO-->
	<div class="grid_8" id="logo"><?=PRO_NAME?></div>
    <div class="grid_8">
<!-- USER TOOLS START -->
